  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 sm:h-20">
            ...
            <Link to="/" className="flex items-center justify-center">
              ...
              />
              <span className="text-white font-semibold text-l sm:text-xl px-2">Exhibition</span>
            </Link>
            ...
            <div className="hidden md:flex items-center space-x-10">
              {links.map((link) => (
                <Link 
                  key={link.name}
                  to={link.href}
                  className="text-sm  font-bold text-blue-500 hover:text-blue-400 transition duration-300 relative group"
                >
                  {link.name}
      ...
      <div
        ...
        `}
      >
        <div className="bg-slate-950/95 backdrop-blur-xl  border-slate-800 shadow-lg">
